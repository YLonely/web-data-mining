...
lda = TopicBasedAlgo(news_tfvec, 20, corpus_tfidf, word_dict, 'lda')
...
print(eva.evaluate(algo=lda, k=10, n_splits=3, shuffle=True, random_state=112, debug=True, verbose=True))
