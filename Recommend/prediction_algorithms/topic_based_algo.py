from Recommend.prediction_algorithms.content_based_algo import ContentBasedAlgo
...
class TopicBasedAlgo(BaseAlgo):
    ...
    def load(cls, fname):
        ...
        setattr(res, '_content_algo', ContentBasedAlgo.load('.'.join([fname, 'content_algo'])))
        return res
